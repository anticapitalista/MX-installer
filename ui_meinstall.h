...
public:
    ...
    void setupUi(QWidget *MeInstall)
    {
        ...
        gridLayout22->addWidget(autologinCheckBox, 2, 0, 1, 1);
        ...
        QWidget::setTabOrder(grubBootCombo, computerNameEdit);
    ...
    void retranslateUi(QWidget *MeInstall)
    {
        ...
        copyrightBrowser->setHtml(QApplication::translate("MeInstall", "<p>MX-14 is an independent linux distribution based on Debian Stable.</p> <p>MX-14 uses some components from MEPIS Linux which are released under an Apache free license. Some MEPIS components have been modified for MX-14.</p> <p>Enjoy using MX-14.</p>", 0, QApplication::UnicodeUTF8));
        ...
        installLabel->setText(QApplication::translate("MeInstall", "Ready to install MX-14 filesystem", 0, QApplication::UnicodeUTF8));
        ...
        grubCheckBox->setText(QApplication::translate("MeInstall", "Install GRUB for MX-14 and Windows", 0, QApplication::UnicodeUTF8));
        ...
        computerGroupEdit->setText(QApplication::translate("MeInstall", "mxgrp", 0, QApplication::UnicodeUTF8));
        ...
        remindersBrowser->setHtml(QApplication::translate("MeInstall", "<p><b>Support MX-14</b><br/>MX-14 is supported by people like you. Some help others at the support forum - http://antix.freeforums.org, - http://forum.mepiscommunity.org or translate help files into different languages, or make suggestions, write documentation, or help test new software.</p>", 0, QApplication::UnicodeUTF8));
